...
export default function FeedPage() {
  ...
  if (isLoading && page === 1) {
    return (
      <div className="space-y-6 min-h-[500px] flex items-center justify-center">
        <div className="flex items-center gap-3 justify-center   backdrop-blur-sm p-4 rounded-md">
