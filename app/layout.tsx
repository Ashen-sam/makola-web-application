            ...
            toastOptions={{
              ...
              success: {
                ...
                style: {
                  ...
                  boxShadow: '0 25px 50px -12px rgba(5, 150, 105, 0.15), 0 10px 20px -5px rgba(5, 150, 105, 0.1)',
                },
              },
              error: {
                iconTheme: {
                ...
                style: {
                  ...
                  boxShadow: '0 25px 50px -12px rgba(220, 38, 38, 0.15), 0 10px 20px -5px rgba(220, 38, 38, 0.1)',
                },
              },
              loading: {
                iconTheme: {
                ...
                style: {
                  ...
                  boxShadow: '0 25px 50px -12px rgba(59, 130, 246, 0.15), 0 10px 20px -5px rgba(59, 130, 246, 0.1)',
                },
              },
            }}
          />
